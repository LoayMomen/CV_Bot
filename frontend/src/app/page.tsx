        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Smart Job Creation</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Resume Parsing</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md">
              <h3 className="text-xl font-semibold text-slate-900 mb-4">Intelligent Matching</h3>
              <p className="text-slate-700">
